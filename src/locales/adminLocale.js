export const adminLocale = {
  en: {
    ...
    labelSlug: 'URL Slug',
    labelReviewGoogle: 'Google Reviews URL',
    labelReviewBooking: 'Booking.com Review URL',
    labelReviewTripadvisor: 'Tripadvisor Review URL',
...
No app needed. Enjoy your stay!`,
  ...
  es: {
    ...
    groupReviewLinks: 'Links de Reseñas',
    ...
    labelReviewGoogle: 'URL de Google Reviews',
    labelReviewBooking: 'URL de reseñas en Booking.com',
    labelReviewTripadvisor: 'URL de Tripadvisor',
...
Sin necesidad de app. ¡Que disfrutes tu estancia!`,
    ...
    answerLabelMap: {
      ...
      // Chatbot quick-action raw topic keys (logged as-is to analytics)
      'breakfast':    'Horario del desayuno',
      ...
      // Also handle legacy display-label variants
